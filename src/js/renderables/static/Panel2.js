...
const testingArea = ({renderer, theme, renderables}) => {
  ...
  const fuelPressureReadout = renderables[RENDER_KEYS.FUEL_PRESSURE];
  ...
  fuelPressureReadout.y = oilPressureReadout.y + oilPressureReadout.height + vert_padding;
  cts.y = fuelPressureReadout.y + fuelPressureReadout.gaugeHeight + vert_padding;
  ign.y = cts.y + cts.gaugeHeight + vert_padding;
  vacReadout.y = ign.y + ign.gaugeHeight + vert_padding;
