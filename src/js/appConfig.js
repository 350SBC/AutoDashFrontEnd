...
const ODOMETER_READOUT_HEIGHT = 60;
const GEAR_READOUT_HEIGHT = 60;
...
export const SCREEN = {
  ...
  SPEEDO_READOUT_HEIGHT: SPEED_CLUSTER_HEIGHT - SPEEDO_SWEEP_SIZE - BORDER_WIDTH - ODOMETER_READOUT_HEIGHT,
  GEAR_READOUT_HEIGHT: GEAR_READOUT_HEIGHT,
  ODOMETER_READOUT_HEIGHT: ODOMETER_READOUT_HEIGHT,
